...
- 约 55 道菜，覆盖 12 个 L4 菜系（例：中国-川菜、中国-粤菜、日本-关西、泰国-泰北、印度-北印、意大利-托斯卡纳、意大利-西西里、希腊-克里特、法国-普罗旺斯、西班牙-安达卢西亚、墨西哥-瓦哈卡、秘鲁-利马、摩洛哥-马拉喀什），其中 1-2 个叶节点 <6 道用于验证保底并池；希腊/南意/西班牙/普罗旺斯打 `mediterranean` 标签，墨西哥+南美打 `latam` 标签。
